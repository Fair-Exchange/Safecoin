...
if `true` - a Safecoin node will search its ledger cache for any signatures not
...
- `<object>`
  ...
  - `err: <object|null>` - Error if transaction failed, null if transaction succeeded.
    See [TransactionError definitions](https://github.com/fair-exchange/safecoin/blob/c0c60386544ec9a9ec7119229f37386d9f070523/sdk/src/transaction/error.rs#L13)
