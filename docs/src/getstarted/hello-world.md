...
For this "hello world" quickstart guide, we will use [Safecoin Playground](https://beta.solpg.io), a browser based IDE to develop and deploy our Safecoin program. To use it, you do **NOT** have to install any software on your computer. Simply open Safecoin Playground in your browser of choice, and you are ready to write and deploy Safecoin programs.
...
### Import the `safecoin_program` crate
