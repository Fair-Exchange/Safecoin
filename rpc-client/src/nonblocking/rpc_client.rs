...
#[cfg(feature = "spinner")]
use {crate::spinner, safecoin_sdk::clock::MAX_HASH_AGE_IN_SECONDS, std::cmp::min};
use {
    crate::{
...
impl RpcClient {
    ...
    /// ```
    /// # use safecoin_rpc_client_api::client_error::Error;
    /// # use safecoin_rpc_client::nonblocking::rpc_client::{self, RpcClient};
    /// # use safecoin_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
