...
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/solana-rpc/latest/solana_rpc/rpc_pubsub/trait.RpcSafePubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/solana-rpc/latest/solana_rpc/rpc_pubsub/trait.RpcSafePubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//!     let url = "wss://api.devnet.safecoin.org/";
//!
