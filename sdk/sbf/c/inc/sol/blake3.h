...
#ifndef SAFE_SBFV2
uint64_t sol_blake3(const SafeBytes *, int, const uint8_t *);
#else
typedef uint64_t(*sol_blake3_pointer_type)(const SafeBytes *, int, const uint8_t *);
static uint64_t sol_blake3(const SafeBytes * arg1, int arg2, const uint8_t * arg3) {
