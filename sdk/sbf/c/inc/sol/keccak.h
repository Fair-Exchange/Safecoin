#pragma once
/**
 * @brief Safecoin keccak system call
**/
...
#ifndef SAFE_SBFV2
uint64_t sol_keccak256(const SafeBytes *, int, uint8_t *);
#else
typedef uint64_t(*sol_keccak256_pointer_type)(const SafeBytes *, int, uint8_t *);
static uint64_t sol_keccak256(const SafeBytes * arg1, int arg2, uint8_t * arg3) {
