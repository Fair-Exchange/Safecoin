...
mod tests {
    ...
    fn test_stake_initialize(feature_set: FeatureSet) {
        ...
        let stake_address = safecoin_sdk::pubkey::new_rand();
        let stake_account = AccountSharedData::new(stake_lamports, StakeState::size_of(), &id());
        let custodian_address = safecoin_sdk::pubkey::new_rand();
        let lockup = Lockup {
            epoch: 1,
            unix_timestamp: 0,
    ...
    fn test_authorize(feature_set: FeatureSet) {
        let authority_address = safecoin_sdk::pubkey::new_rand();
        let authority_address_2 = safecoin_sdk::pubkey::new_rand();
        let stake_address = safecoin_sdk::pubkey::new_rand();
        ...
        .unwrap();
        let to_address = safecoin_sdk::pubkey::new_rand();
    ...
    fn test_authorize_override(feature_set: FeatureSet) {
        let authority_address = safecoin_sdk::pubkey::new_rand();
        let mallory_address = safecoin_sdk::pubkey::new_rand();
        let stake_address = safecoin_sdk::pubkey::new_rand();
        let stake_lamports = 42;
        let stake_account = AccountSharedData::new_data_with_space(
            stake_lamports,
    ...
    fn test_authorize_with_seed(feature_set: FeatureSet) {
        let authority_base_address = safecoin_sdk::pubkey::new_rand();
        let authority_address = safecoin_sdk::pubkey::new_rand();
        let seed = "42";
    ...
    fn test_authorize_delegated_stake(feature_set: FeatureSet) {
        ...
        .unwrap();
        let vote_address = safecoin_sdk::pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &safecoin_sdk::pubkey::new_rand(), 0, 100);
        let vote_address_2 = safecoin_sdk::pubkey::new_rand();
        let mut vote_account_2 =
            vote_state::create_account(&vote_address_2, &safecoin_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_stake_delegate(feature_set: FeatureSet) {
        ...
        transaction_accounts[1]
            .1
            .set_owner(safecoin_sdk::pubkey::new_rand());
        process_instruction(
            &feature_set,
            &serialize(&StakeInstruction::DelegateStake).unwrap(),
            transaction_accounts.clone(),
    ...
    fn test_redelegate_consider_balance_changes(feature_set: FeatureSet) {
        ...
        let recipient_address = safecoin_sdk::pubkey::new_rand();
        let authority_address = safecoin_sdk::pubkey::new_rand();
        let vote_address = safecoin_sdk::pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &safecoin_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_split(feature_set: FeatureSet) {
        ...
        let split_to_address = safecoin_sdk::pubkey::new_rand();
    ...
    fn test_set_lockup(feature_set: FeatureSet) {
        let custodian_address = safecoin_sdk::pubkey::new_rand();
        let authorized_address = safecoin_sdk::pubkey::new_rand();
        let stake_address = safecoin_sdk::pubkey::new_rand();
        let minimum_delegation = crate::get_minimum_delegation(&feature_set);
        let stake_lamports = minimum_delegation;
        let stake_account = AccountSharedData::new_data_with_space(
    ...
    fn test_merge(feature_set: FeatureSet) {
        let stake_address = safecoin_sdk::pubkey::new_rand();
        let merge_from_address = safecoin_sdk::pubkey::new_rand();
        let authorized_address = safecoin_sdk::pubkey::new_rand();
    ...
    fn test_merge_incorrect_authorized_staker(feature_set: FeatureSet) {
        ...
        let merge_from_address = safecoin_sdk::pubkey::new_rand();
        let authorized_address = safecoin_sdk::pubkey::new_rand();
        let wrong_authorized_address = safecoin_sdk::pubkey::new_rand();
        let stake_lamports = 42;
        let mut instruction_accounts = vec![
            AccountMeta {
                pubkey: stake_address,
