...
const MIN_STAKE_FOR_GOSSIP: u64 = safecoin_sdk::native_token::LAMPORTS_PER_SAFE;
...
mod tests {
    ...
    fn test_cluster_info_trace() {
        ...
        let node = {
            let tpu = SocketAddr::new(IpAddr::V4(Ipv4Addr::LOCALHOST), 8329);
...
------------------+-------+----------------------------------------------+---------+------+-------+------+------+------+------+------+------+--------
127.0.0.1       me|     \d | 7fGBVaezz2YrTxAkwvLjBZpxrGEfNsd14Jxw9W5Df5zY |    -    | 8888 |  8906 | 8329 | 8904 | 8902 | 8903 | 8907 | 8910 | 0
Nodes: 1
