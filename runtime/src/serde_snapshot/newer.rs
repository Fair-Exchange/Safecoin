use {
    ...
    safecoin_sdk::{deserialize_utils::ignore_eof_error, stake::state::Delegation},
...
impl<'a> safecoin_frozen_abi::abi_example::IgnoreAsHelper for SerializableVersionedBank<'a> {}
