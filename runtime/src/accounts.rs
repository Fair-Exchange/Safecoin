use {
    ...
    safecoin_sdk::{
        ...
        clock::{BankId, Slot},
        feature_set::{
            self, enable_request_heap_frame_ix, remove_deprecated_request_unit_ix,
...
impl Accounts {
    ...
    fn load_transaction_accounts(
        ...
        let set_exempt_rent_epoch_max =
            feature_set.is_active(&safecoin_sdk::feature_set::set_exempt_rent_epoch_max::id());
        ...
        let mut accounts = account_keys
            ...
            .map(|(i, key)| {
                ...
                let account = if safecoin_sdk::sysvar::instructions::check_id(key) {
...
mod tests {
    use {
        ...
        safecoin_program_runtime::executor_cache::TransactionExecutorCache,
        safecoin_sdk::{
    ...
    fn test_load_accounts_invalid_account_for_fee() {
        ...
        let account = AccountSharedData::new(1, 1, &safecoin_sdk::pubkey::new_rand()); // <-- owner is not the system program
        accounts.push((key0, account));
